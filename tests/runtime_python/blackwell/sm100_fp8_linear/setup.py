...
setup(
    name='runtime_kernel_fp8_blackwell',
    ext_modules=[
        CUDAExtension(
            name='runtime_kernel_fp8_blackwell',
            sources=[
                os.path.join(this_dir, 'runtime_kernel_wrapper_fp8_sm100.cu'),
            ],
            depends=[
                os.path.join(this_dir, '../../../../include/mirage/persistent_kernel/tasks/blackwell/fp8_linear_sm100_mpk.cuh'),
