 ...
 */
 ...
 private:
   __host__ static inline void create_tma_desc(CUtensorMap *tma_desc,
     ...
     uint64_t gmem_prob_shape[5] = {GMEM_COL, GMEM_ROW, GMEM_DEPTH, 1, 1};
     uint64_t gmem_prob_stride[5] = {sizeof(T), GMEM_COL * sizeof(T), GMEM_COL * GMEM_ROW * sizeof(T), 0, 0};
