...
namespace kernel {
  ...
  __device__ static inline void
      wgmma_m64n64k16_bf16bf16bf32(bool accum, uint64_t const &desc_a,
  ...
  template <typename T,
            ...
            bool tnspA,
            bool tnspB>
  __device__ static inline void mma(float *frag, A_DESC a_desc, B_DESC b_desc, bool accum) {
    ...
    if constexpr (M == 64 && N == 64 && K == 16 &&
      ...
      for (int k = 0; k < (SMEM_A::COL / K); k++) {
        wgmma_m64n64k16_bf16bf16bf32<tnspA, tnspB>(accum, a_desc.at(k * 16 * sizeof(T)),
